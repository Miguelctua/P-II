...
public class DelayArray<E> {
  ...
  public DelayArray(int size, E init) {
    assert size >= 0;
    // Nao FALTA criar array de size elementos de tipo E (tem truque!)
    ...
    // Nao FALTA encher buffer com size amostras com o valor "init"
   ...
   */
  public void in(E x) {
    // Nao FALTA colocar x na posição next e incrementar next,
