...
public class Data {
  ...
  private static final
	String[] diasMesComumNome = {"Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"};
  /** Devolve o mes da data por extenso. */
  public String mesExtenso() {
    return diasMesComumNome[mes()-1];
  }
